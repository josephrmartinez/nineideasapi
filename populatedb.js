...
const topicsArray = 
  [
    ...
    "Ways to incorporate more physical activity into your daily routine",
    ...
    "Ways to connect with nature that will leave you feeling rejuvenated",
    "Acts of kindness that will make a positive impact on the lives of others",
    "Good habits to form",
    "Social activities that will help you connect with others on a deeper level",
    "Relationship advice to build and maintain healthy relationships",
    "Travel experiences that will change your perspective on the world",
  ...
  "Ways to incorporate more inspiring pieces into home or office decor",
  ...
  "Innovative ways to embed eco-consciousness in everyday practices",
  ...
  "Incorporating ethics and belief systems into home decor",
  "Meaningful traditions: Ideas for new family traditions",
  "Inspiring personal growth via solitude: Creating an introspection spot at home",
  ...
  "Profit with a purpose: Community-focused businesses",
  "Strategies for improving mental health",
  "Ways to nurture the art of slow living",
  "Create an oasis of serenity",
  "Spiritual experiences",
  "Ways to make friends with other adults",
  "How to spend a gap year between high school and college",
  "Alternatives to college",
  "Build connections between multiple generations",
  "Youth summer camp themes",
  "21st century historical landmarks",
  "Groups of people I have bias against",
  "New holidays or traditions and how to celebrate",
  "Ways to experience being in nature",
  "Charitable causes that I find worthy or compelling",
  "DIY projects that would be challenging but worthwhile",
  "Taboos I would be interested in exploring",
  "Social norms I think are worth questioning",
  "Alternatives to standard wedding traditions",
  "Pushing boundaries with cooking at home",
  "More fulfilling ways to travel",
  "Boutique hotel concepts I would actually enjoy",
  "New college majors",
  "Radical ways to redefine success and happiness",
  "Immersive virtual reality experiences I would want to try",
  "Subversive approaches to eco-conscious living",
  "Ways to escape the trap of consumerism",
  "Ways to explore self-expression",
  "Things I would do as a parent",
  "Nine wishes",
  "30-day self-improvement challenges",
  "Crafting a unique and personalized wedding ceremony",
  "Mobile apps or websites I would actually benefit from using",
  "Ways to be more adventurous when I travel",
  "Alternatives to community gardens",
  "Things to get rid of",
  "Ways to raise money for a organization or cause I care about",
  "Designing an interactive art installation for a public space",
  "Good habits"
  ]